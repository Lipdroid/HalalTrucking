/**
 * Desciption: Correct Multiple screen with screen size  = 640
 * Version: 1.1
...
public class MultipleScreen {
	...
	/*--
	 * Desciption: create SCMultipleScreen Ultility for get scale value
	...
	/*--
	 * Desciption: create SCMultipleScreen Ultility
	 * Author: Tran Quang Long
	 * Create date: Sep 3, 2013
...
//		return disp.getWidth() * 1.0f / actualSreenWidth;
		...
		int actualSreenWidth = SCREEN_WIDTH_SIZE;
		return mScreenW * 1.0f / actualSreenWidth;
	}
	 ...
	 * 
	 * TODO
	 * Function:<br>Get real screen width
	 * @return srceen width
	 * @author: Munir Hossain
	 * @date: Apr 15, 2015
	 */
	 ...
	 * 
	 * TODO
	 * Function:<br>Get real screen height
	 * @return srceen height
	 * @author: Munir Hossain
	 * @date: Apr 15, 2015
	 */
